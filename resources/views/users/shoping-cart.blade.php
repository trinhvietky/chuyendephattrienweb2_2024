						...
						<tbody class="table-body">
							...
							<tr class="table_row">
								<td class="column-1" style="padding-left: 20px;">
									<input type="checkbox" class="select-item" style="appearance:auto" data-index="{{ $index }}"> <!-- Checkbox cho mỗi sản phẩm -->
								</td>
								<td class="column-2 ">
								...
								<td class="column-5 text-center">
									<div class="wrap-num-product flex-w m-l-auto m-r-0">
										...
										<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="{{$cart->quantity}}" data-cart-id="{{ $cart->cart_id }}">
