                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <a class="has-arrow" href="{{route('voucher_list')}}" aria-expanded="false"><i class="icon nalika-menu-task icon-wrap"></i> <span class="mini-click-non">Voucher</span></a>
                        </li>
                        <!-- <li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <div style="margin-top: -10px;">
                                                    <x-dropdown align="right" width="48">
                                                        ...
                                                        <x-slot name="content">
                                                            <x-dropdown-link :href="route('profile.edit')" class="text-xl font-bold py-4 px-6">
                                                                {{ __('Profile') }}
                                                            </x-dropdown-link>
                                                            ...
                                                            <form method="POST" action="{{ route('logout') }}">
                                                                @csrf
                                                                <x-dropdown-link :href="route('logout')" class="text-xl font-bold py-4 px-6"
